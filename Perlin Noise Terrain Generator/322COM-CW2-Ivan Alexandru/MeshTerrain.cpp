...
MeshTerrain::MeshTerrain(int rows, int cols)
{
...
void MeshTerrain::createMesh(int rows, int cols)
{
...
void MeshTerrain::createNormals()
{
...
void MeshTerrain::createVertex(glm::vec3 pos, glm::vec2 texCoord)
{
